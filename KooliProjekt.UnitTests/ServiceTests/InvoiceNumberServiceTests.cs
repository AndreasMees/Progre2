...
namespace KooliProjekt.UnitTests.ServiceTests
{
    public class InvoiceNumberServiceTests
    {
        ...
        {
            using var context = CreateDbContext();
            context.Invoices.Add(new Invoice { InvoiceNo = "INV-0005", InvoiceDate = DateTime.Now });
            context.SaveChanges();
            var service = new InvoiceNumberService(context);
        ...
        {
            using var context = CreateDbContext();
            context.Invoices.Add(new Invoice { InvoiceNo = "BADFORMAT", InvoiceDate = DateTime.Now });
            context.SaveChanges();
            var service = new InvoiceNumberService(context);
